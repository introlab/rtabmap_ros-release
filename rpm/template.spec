...
Name:           ros-humble-rtabmap-util
Version:        0.23.7
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS rtabmap_util package

License:        BSD
URL:            https://index.ros.org/p/rtabmap_util/#humble
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-cv-bridge
Requires:       ros-humble-grid-map-ros
...
BuildRequires:  ros-humble-grid-map-ros
...
BuildRequires:  ros-humble-rtabmap-conversions
BuildRequires:  ros-humble-rtabmap-msgs
BuildRequires:  ros-humble-rtabmap-sync
