...
Name:           ros-kilted-rtabmap-costmap-plugins
Version:        0.23.7
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS rtabmap_costmap_plugins package

License:        BSD
URL:            https://index.ros.org/p/rtabmap_costmap_plugins/#kilted
